...
class TMacrosV3(KaitaiStruct):
    ...
    def _read(self):
        ...
        if _on == 14:
            ...
            self.content = self._root.TMacrosV3Macro414d(self._io, self, self._root)
        elif _on == 17:
            ...
            self.content = self._root.TMacrosV3MacroC0ff(self._io, self, self._root)
        elif _on == 99:
            ...
            self.content = self._root.TMacrosV3MacroFf02(self._io, self, self._root)
        elif _on == 53:
            ...
            self.content = self._root.TMacrosV3Macro614d(self._io, self, self._root)
        elif _on == 44:
            ...
            self.content = self._root.TMacrosV3Macro00f0(self._io, self, self._root)
        elif _on == 21:
            ...
            self.content = self._root.TMacrosV3MacroC20c(self._io, self, self._root)
        elif _on == 34:
