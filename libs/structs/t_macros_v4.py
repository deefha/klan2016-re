...
class TMacrosV4(KaitaiStruct):
    ...
    def _read(self):
        ...
        _on = self.type
        if _on == 14:
            self.content = TMacrosV4.TMacrosV4Macro000e(self._io, self, self._root)
        elif _on == 10:
            self.content = TMacrosV4.TMacrosV4Macro000a(self._io, self, self._root)
        elif _on == 16717:
            self.content = TMacrosV4.TMacrosV4Macro414d(self._io, self, self._root)
        elif _on == 17:
            self.content = TMacrosV4.TMacrosV4Macro0011(self._io, self, self._root)
        elif _on == 4:
            self.content = TMacrosV4.TMacrosV4Macro0004(self._io, self, self._root)
        elif _on == 39:
            self.content = TMacrosV4.TMacrosV4Macro0027(self._io, self, self._root)
        elif _on == 24:
            self.content = TMacrosV4.TMacrosV4Macro0018(self._io, self, self._root)
        elif _on == 35:
            self.content = TMacrosV4.TMacrosV4Macro0023(self._io, self, self._root)
        elif _on == 6:
            self.content = TMacrosV4.TMacrosV4Macro0006(self._io, self, self._root)
        elif _on == 20:
            self.content = TMacrosV4.TMacrosV4Macro0014(self._io, self, self._root)
        elif _on == 32:
            self.content = TMacrosV4.TMacrosV4Macro0020(self._io, self, self._root)
        elif _on == 7:
            self.content = TMacrosV4.TMacrosV4Macro0007(self._io, self, self._root)
        elif _on == 1:
            self.content = TMacrosV4.TMacrosV4Macro0001(self._io, self, self._root)
        elif _on == 55:
            self.content = TMacrosV4.TMacrosV4Macro0037(self._io, self, self._root)
        elif _on == 13:
            self.content = TMacrosV4.TMacrosV4Macro000d(self._io, self, self._root)
        elif _on == 56:
            self.content = TMacrosV4.TMacrosV4Macro0038(self._io, self, self._root)
        elif _on == 45:
            self.content = TMacrosV4.TMacrosV4Macro002d(self._io, self, self._root)
        elif _on == 11:
            self.content = TMacrosV4.TMacrosV4Macro000b(self._io, self, self._root)
        elif _on == 12:
            self.content = TMacrosV4.TMacrosV4Macro000c(self._io, self, self._root)
        elif _on == 5:
            self.content = TMacrosV4.TMacrosV4Macro0005(self._io, self, self._root)
        elif _on == 33:
            self.content = TMacrosV4.TMacrosV4Macro0021(self._io, self, self._root)
        elif _on == 49407:
            self.content = TMacrosV4.TMacrosV4MacroC0ff(self._io, self, self._root)
        elif _on == 99:
            self.content = TMacrosV4.TMacrosV4Macro0063(self._io, self, self._root)
        elif _on == 19:
            self.content = TMacrosV4.TMacrosV4Macro0013(self._io, self, self._root)
        elif _on == 51:
            self.content = TMacrosV4.TMacrosV4Macro0033(self._io, self, self._root)
        elif _on == 23:
            self.content = TMacrosV4.TMacrosV4Macro0017(self._io, self, self._root)
        elif _on == 65282:
            self.content = TMacrosV4.TMacrosV4MacroFf02(self._io, self, self._root)
        elif _on == 53:
            self.content = TMacrosV4.TMacrosV4Macro0035(self._io, self, self._root)
        elif _on == 15:
            self.content = TMacrosV4.TMacrosV4Macro000f(self._io, self, self._root)
        elif _on == 38:
            self.content = TMacrosV4.TMacrosV4Macro0026(self._io, self, self._root)
        elif _on == 40:
            self.content = TMacrosV4.TMacrosV4Macro0028(self._io, self, self._root)
        elif _on == 24909:
            self.content = TMacrosV4.TMacrosV4Macro614d(self._io, self, self._root)
        elif _on == 44:
            self.content = TMacrosV4.TMacrosV4Macro002c(self._io, self, self._root)
        elif _on == 9:
            self.content = TMacrosV4.TMacrosV4Macro0009(self._io, self, self._root)
        elif _on == 240:
            self.content = TMacrosV4.TMacrosV4Macro00f0(self._io, self, self._root)
        elif _on == 21:
            self.content = TMacrosV4.TMacrosV4Macro0015(self._io, self, self._root)
        elif _on == 37:
            self.content = TMacrosV4.TMacrosV4Macro0025(self._io, self, self._root)
        elif _on == 41:
            self.content = TMacrosV4.TMacrosV4Macro0029(self._io, self, self._root)
        elif _on == 36:
            self.content = TMacrosV4.TMacrosV4Macro0024(self._io, self, self._root)
        elif _on == 18:
            self.content = TMacrosV4.TMacrosV4Macro0012(self._io, self, self._root)
        elif _on == 20302:
            self.content = TMacrosV4.TMacrosV4Macro4f4e(self._io, self, self._root)
        elif _on == 49676:
            self.content = TMacrosV4.TMacrosV4MacroC20c(self._io, self, self._root)
        elif _on == 34:
            self.content = TMacrosV4.TMacrosV4Macro0022(self._io, self, self._root)
        elif _on == 54:
            self.content = TMacrosV4.TMacrosV4Macro0036(self._io, self, self._root)
        elif _on == 43:
            self.content = TMacrosV4.TMacrosV4Macro002b(self._io, self, self._root)
        elif _on == 22:
            self.content = TMacrosV4.TMacrosV4Macro0016(self._io, self, self._root)
    ...
    class TMacrosV4Macro0063ModeIfOnly(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.branch_if = TMacrosV4.TMacrosV4Macro0063BranchIf(self._parent.foo_1, _io__raw_branch_if, self, self._root)
    ...
    class TMacrosV4Macro0063(KaitaiStruct):
        ...
        def _read(self):
            ...
            _on = self.mode
            if _on == 1:
                self.branches = TMacrosV4.TMacrosV4Macro0063ModeIfElse(self._io, self, self._root)
            else:
                self.branches = TMacrosV4.TMacrosV4Macro0063ModeIfOnly(self._io, self, self._root)
    ...
    class TMacrosV4Macro0063ModeIfElse(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.branch_else = TMacrosV4.TMacrosV4Macro0063BranchElse(_io__raw_branch_else, self, self._root)
