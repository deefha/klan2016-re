...
import t_header
class KlanAudioV3(KaitaiStruct):
    """
    .. seealso::
    ...
    def _read(self):
        ...
        self.fat = KlanAudioV3.TFat(self._io, self, self._root)
        self.data = KlanAudioV3.TData(self._io, self, self._root)
    ...
    class TData(KaitaiStruct):
        ...
        def waves(self):
            ...
            for i in range(8192):
                self._m_waves[i] = KlanAudioV3.TWave(self._parent.fat.offsets[i], self._io, self, self._root)
    ...
    class TWaveContent(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.data = KlanAudioV3.TWaveData(self.data_size, self._io, self, self._root)
    ...
    class TWave(KaitaiStruct):
        ...
        def content(self):
            ...
            if self.param_offset != 0:
                ...
                self._m_content = KlanAudioV3.TWaveContent(self._io, self, self._root)
                self._io.seek(_pos)
