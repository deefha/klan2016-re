...
class KlanScreensV1(KaitaiStruct):
    ...
    def _read(self):
        self.header = KlanScreensV1.THeader(self._io, self, self._root)
        self.fat = KlanScreensV1.TFat(self._io, self, self._root)
        self.data = KlanScreensV1.TData(self._io, self, self._root)
    ...
    class TData(KaitaiStruct):
        ...
        def screens(self):
            ...
            for i in range(255):
                self._m_screens[i] = KlanScreensV1.TScreen(self._parent.fat.offsets[i], self._io, self, self._root)
    ...
    class TScreenDataEventContent(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.data = KlanScreensV1.TScreenDataEventMacros(_io__raw_data, self, self._root)
    ...
    class TScreenContent(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.data = KlanScreensV1.TScreenData(self._io, self, self._root)
    ...
    class TScreenData(KaitaiStruct):
        ...
        def _read(self):
            ...
            i = 0
            while True:
                _ = KlanScreensV1.TScreenDataEvent(self._io, self, self._root)
    ...
    class TScreenDataEvent(KaitaiStruct):
        ...
        def _read(self):
            ...
            if self.binding != 65535:
                self.content = KlanScreensV1.TScreenDataEventContent(self._io, self, self._root)
    ...
    class TScreenDataEventMacros(KaitaiStruct):
        ...
        def _read(self):
            ...
            while not self._io.is_eof():
                self.macros.append(t_macros_v1.TMacrosV1(self._io))
                i += 1
    ...
    class TScreen(KaitaiStruct):
        ...
        def content(self):
            ...
            if self.param_offset != 4294967295:
                ...
                self._m_content = KlanScreensV1.TScreenContent(self._io, self, self._root)
                self._io.seek(_pos)
