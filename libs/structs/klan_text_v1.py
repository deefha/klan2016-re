...
class KlanTextV1(KaitaiStruct):
        ...
        def _read(self):
            ...
            if self.height != 0:
                ...
                for i in range(self.height):
                    self.rows[i] = KlanTextV1.TLinetableContentPiece8Row(self._io, self, self._root)
    ...
    class TLinetableContentPiece(KaitaiStruct):
        ...
        def _read(self):
            ...
            if  ((self.raw == 1) or (self.raw == 8) or (self.raw == 9) or (self.raw == 32)) :
                _on = self.raw
                if _on == 1:
                    self.data = KlanTextV1.TLinetableContentPiece1(self._io, self, self._root)
                elif _on == 8:
                    self.data = KlanTextV1.TLinetableContentPiece8(self._io, self, self._root)
                elif _on == 9:
                    self.data = KlanTextV1.TLinetableContentPiece9(self._io, self, self._root)
                elif _on == 32:
                    self.data = KlanTextV1.TLinetableContentPiece32(self._io, self, self._root)
    ...
    class TLinktable(KaitaiStruct):
        ...
        def content(self):
            ...
            self._m_content = KlanTextV1.TLinktableContent(_io__raw__m_content, self, self._root)
            self._io.seek(_pos)
            return self._m_content if hasattr(self, '_m_content') else None
    ...
    class TLinetable(KaitaiStruct):
        ...
        def content(self):
            ...
            self._raw__m_content = self._io.read_bytes(self.param_length)
            _io__raw__m_content = KaitaiStream(BytesIO(self._raw__m_content))
            self._m_content = KlanTextV1.TLinetableContent(_io__raw__m_content, self, self._root)
            self._io.seek(_pos)
            return self._m_content if hasattr(self, '_m_content') else None
    ...
    class TLinetableContentPiece8Row(KaitaiStruct):
        ...
        def _read(self):
            ...
            i = 0
            while True:
                _ = KlanTextV1.TLinetableContentPiece8RowData(self._io, self, self._root)
    ...
    class TLinetableMeta(KaitaiStruct):
        ...
        def content(self):
            ...
            _pos = self._io.pos()
            self._io.seek(self.param_offset)
            self._m_content = KlanTextV1.TLinetableMetaContent(self._io, self, self._root)
            self._io.seek(_pos)
            return self._m_content if hasattr(self, '_m_content') else None
    ...
    class TLinetableContent(KaitaiStruct):
        ...
        def _read(self):
            ...
            while not self._io.is_eof():
                self.pieces.append(KlanTextV1.TLinetableContentPiece(self._io, self, self._root))
                i += 1
    ...
    class TLinktableMeta(KaitaiStruct):
        ...
        def content(self):
            ...
            _pos = self._io.pos()
            self._io.seek(self.param_offset)
            self._m_content = KlanTextV1.TLinktableMetaContent(self._io, self, self._root)
            self._io.seek(_pos)
            return self._m_content if hasattr(self, '_m_content') else None
    ...
    def linetable_meta(self):
        ...
        if self.count_linetable_meta != 0:
            ...
            for i in range(self.count_linetable_meta):
                self._m_linetable_meta[i] = KlanTextV1.TLinetableMeta((self.offset_linetable_meta + (17 * i)), self._io, self, self._root)
    ...
    def linktable_meta(self):
        ...
        if self.count_linktable != 0:
            ...
            for i in range(self.count_linktable):
                self._m_linktable_meta[i] = KlanTextV1.TLinktableMeta((self.offset_linktable_meta + (20 * i)), self._io, self, self._root)
    ...
    def palettetable(self):
        ...
        if self.count_palettetable != 0:
            ...
            for i in range(self.count_palettetable):
                self._m_palettetable[i] = KlanTextV1.TPalettetable((self.offset_palettetable + (768 * i)), self._io, self, self._root)
        ...
        if self.count_linetable_meta != 0:
            ...
            for i in range(self.count_linetable_meta):
                ...
                if _on == (self.count_linetable_meta - 1):
                    self._m_linetable[i] = KlanTextV1.TLinetable(self.linetable_meta[i].content.offset, (self.offset_palettetable - self.linetable_meta[i].content.offset), self._io, self, self._root)
                else:
                    self._m_linetable[i] = KlanTextV1.TLinetable(self.linetable_meta[i].content.offset, (self.linetable_meta[(i + 1)].content.offset - self.linetable_meta[i].content.offset), self._io, self, self._root)
        ...
        if self.count_linktable != 0:
            ...
            for i in range(self.count_linktable):
                ...
                if _on == (self.count_linktable - 1):
                    self._m_linktable[i] = KlanTextV1.TLinktable(self.linktable_meta[i].content.offset, (self.offset_linktable_meta - self.linktable_meta[i].content.offset), self._io, self, self._root)
                else:
                    self._m_linktable[i] = KlanTextV1.TLinktable(self.linktable_meta[i].content.offset, (self.linktable_meta[(i + 1)].content.offset - self.linktable_meta[i].content.offset), self._io, self, self._root)
