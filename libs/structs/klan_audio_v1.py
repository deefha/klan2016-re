...
import t_header
class KlanAudioV1(KaitaiStruct):
    """
    .. seealso::
    ...
    def _read(self):
        ...
        self.fat = KlanAudioV1.TFat(self._io, self, self._root)
        self.data = KlanAudioV1.TData(self._io, self, self._root)
    ...
    class TData(KaitaiStruct):
        ...
        def waves(self):
            ...
            for i in range(8192):
                self._m_waves[i] = KlanAudioV1.TWave(self._parent.fat.offsets[i], self._io, self, self._root)
    ...
    class TWaveContent(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.data = KlanAudioV1.TWaveData(self.data_size, self._io, self, self._root)
    ...
    class TWave(KaitaiStruct):
        ...
        def content(self):
            ...
            if self.param_offset != 0:
                ...
                self._m_content = KlanAudioV1.TWaveContent(self._io, self, self._root)
                self._io.seek(_pos)
